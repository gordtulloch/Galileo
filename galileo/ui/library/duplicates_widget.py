...
from galileo.library.core.duplicates import find_duplicate_hashes
...
class DuplicatesWidget(QWidget):
    ...
    def refresh_duplicates(self):
        ...
        try:
            ...
            duplicate_hashes = find_duplicate_hashes()
    ...
    def delete_duplicates(self):
        ...
        try:
            ...
            duplicate_hashes = [h for h, _count in find_duplicate_hashes()]
            ...
            QMessageBox.critical(
                self,
                "Deletion Error",
                f"An error occurred during deletion: {e!s}"
            )
