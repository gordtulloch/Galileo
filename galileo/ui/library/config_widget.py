...
class ConfigWidget(QWidget):
    ...
    def create_general_tab(self):
        """Create the General tab with General Settings, External Tools, and Suppress Warnings."""
        general_tab = QWidget()
        ...
        self.save_modified_headers.setToolTip("When enabled, Galileo will save any header modifications back to the FITS files")
    ...
    def create_cloud_sync_tab(self):
        ...
        self.bucket_url.setPlaceholderText("e.g., galileo-repository")
        self.bucket_url.setText("galileo-repository")
    ...
    def create_calibration_tab(self):
        ...
        self.frame_processing_method.setToolTip(
            ...
            "Internal: Uses Galileo's built-in processing functions.\n"
    ...
    def get_cloud_config(self):
        """Get cloud configuration in format expected by the cloud sync services"""
        return {
