...
"""
Galileo Register Existing Files Command
==========================================
...
Usage:
    python -m galileo.commands.register_existing [options]

Options:
    --config PATH          Configuration file path (default: library.ini in the Galileo config folder)
...
Examples:
    ...
    python -m galileo.commands.register_existing
    
    # Verbose mode with header verification
    python -m galileo.commands.register_existing --verbose
    
    # Fast scan without header verification
    python -m galileo.commands.register_existing --no-header-verify --quiet
    
    # Dry run to see what would be done
    python -m galileo.commands.register_existing --dry-run --verbose

Author: Galileo Development Team
Version: 1.0
Date: October 2025
"""
...
def main():
    ...
    parser.add_argument('--config',
                       default=None,
                       help='Configuration file path (default: library.ini in the Galileo config folder)')
    ...
    parser.add_argument('--log-file',
                       default='library.log',
                       help='Write log output to file (default: library.log in the Galileo log folder)')
    ...
    try:
        ...
        logger.info("Registration options:")
