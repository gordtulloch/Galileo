...
r"""galileo.commands.reset_calibration_test_state - Reset calibration test state
...
This command will:
  1) Delete calibrated output FITS files generated by Galileo calibration
...
Usage:
    .\\.venv\\Scripts\\python .\\commands\\galileo.commands.reset_calibration_test_state
...
def _is_generated_calibrated_output(row: FitsFileModel) -> bool:
    """Heuristic for calibrated outputs produced by Galileo."""
