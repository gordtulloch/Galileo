...
r"""galileo.commands.photometry - Command line utility for automated aperture photometry on FITS/XISF images.

This is an initial v1.3.0 scaffold: it performs instrumental aperture photometry
and writes a CSV per input image.

Examples:
    .venv\Scripts\python commands\galileo.commands.photometry path\to\image.fits
    .venv\Scripts\python commands\galileo.commands.photometry path\to\image.xisf --aperture 5
    .venv\Scripts\python commands\galileo.commands.photometry path\to\folder --glob "*_astro.fits"
"""
...
def main() -> int:
    ...
    from galileo.library.core.photometry import PhotometryOptions, run_aperture_photometry, write_photometry_csv
    from galileo.library.core.file_processing import FileProcessor
