...
r"""galileo.commands.stack - Command line utility for batch stacking light sessions

This command stacks light sessions using Galileo's internal sigma-clipped stacker.
...
Examples:
  .venv\Scripts\python commands\galileo.commands.stack --all
  .venv\Scripts\python commands\galileo.commands.stack --unstacked
  .venv\Scripts\python commands\galileo.commands.stack --session 12345
  .venv\Scripts\python commands\galileo.commands.stack --unstacked --dry-run
    .venv\Scripts\python commands\galileo.commands.stack --session 12345 --photometric
"""
...
def main() -> int:
    ...
    logger.info('=== Galileo Stack Starting ===')
