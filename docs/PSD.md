...
| DSS | Digitized Sky Survey — the STScI sky-image source used for target thumbnails (`SKY-080`), cropped to the target's own angular size rather than a fixed cutout (Section 8, `SKY`) |
